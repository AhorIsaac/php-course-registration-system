            ...
            <div class="col-sm-6 col-md-6 mt-5">
                <div class="card mt-5 shadow bg-transparent">
                    <div class="card-header bg-success">
                        <h3 class="course-heading"> Student Login </h3>
                        ...
                        ?>
                            <div class='alert alert-warning alert-dismissible fade show d-inline-block' role="alert" id="msg_frame">
                                ...
                                <p class="text-dark font-weight-bold">
                                    <i class="fa fa-user-times fa-1x"></i> Invalid Registration Number!
                                </p>
                            </div>
                        <?php
                        }
                    ...
                    <div class="card-body">
                        <form method="POST" action="../controllers/StudentLoginController.php">
                            ...
                            <div class="form-group">
                                ...
                                <input class="btn btn-success btn-md" type="submit" name="student_login" value="Login" />
                            </div>
                        </form>
                    </div>
                </div>
